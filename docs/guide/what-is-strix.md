...
**Project Strix** is the official autonomous web dashboard and orchestration layer for the Strix AI penetration testing engine. While the core engine is a Python-based CLI agent, this project provides the enterprise-grade UI, database management, and background scheduling required to run those agents at scale.
