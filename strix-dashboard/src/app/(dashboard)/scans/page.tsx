...
const LLM_MODELS = [
  ...
  { value: "openrouter/nvidia/nemotron-3-ultra-550b-a55b:free", label: "OpenRouter Nemotron 3 Ultra (Free)" },
  ...
  { value: "openrouter/google/lyria-3-pro-preview", label: "OpenRouter Lyria 3 Pro Preview (Free)" },
